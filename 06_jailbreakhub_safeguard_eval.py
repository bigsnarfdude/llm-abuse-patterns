#!/usr/bin/env python3
"""
JailbreakHub Evaluation - Official GPT-OSS Safeguard Model
-----------------------------------------------------------
Evaluate detection methods using OFFICIAL gpt-oss-safeguard:20b model.
Tests heuristic, real LLM, and LAYERED defense on real-world attacks.
...
This uses the OFFICIAL OpenAI GPT-OSS Safeguard model for comparison.

Requirements:
- pip install datasets
- Ollama running with gpt-oss-safeguard:20b model
...
class RealLLMDetector:
    """REAL LLM detector using OFFICIAL GPT-OSS Safeguard 20B on M2"""

    def __init__(self):
        try:
            self.detector = SafeguardDetector(
                model="gpt-oss-safeguard:latest",  # Official model uses :latest tag
...
def print_results(results):
    ...
    print("\n" + "=" * 100)
    print("JAILBREAKHUB EVALUATION RESULTS - Official GPT-OSS Safeguard Model")
    print("=" * 100)
...
def main():
    ...
    print("=" * 100)
    print("JAILBREAKHUB EVALUATION - Official GPT-OSS Safeguard Model")
    print("Testing with OFFICIAL gpt-oss-safeguard:20b model")
    ...
    print("\n" + "=" * 100)
    print("✅ EVALUATION COMPLETE - Official GPT-OSS Safeguard Model")
    print("=" * 100)
    print("\nThese are REAL academic baseline numbers using OFFICIAL gpt-oss-safeguard:20b model.")
    ...
    print("Model: OpenAI GPT-OSS Safeguard 20B (official release)")
