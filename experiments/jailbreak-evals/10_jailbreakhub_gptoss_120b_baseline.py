...
This tests the base GPT-OSS 120B model with custom jailbreak detection prompt.
...
class JailbreakHubEvaluator:
    ...
    def __init__(self, sample_size=400):
        ...
        self.llm = GPTOSSDetector(model="gpt-oss:120b")
    ...
    def run_full_evaluation(self):
        ...
        llm_results = self.evaluate_single_method(self.llm, dataset, "GPT-OSS 120B", n_jailbreaks, n_benign)
...
def print_results(results):
    ...
    print("\n" + "=" * 100)
    print("JAILBREAKHUB EVALUATION RESULTS - GPT-OSS 120B Baseline (Regular Model)")
    print("=" * 100)
    ...
    for method_key, method_name in [('heuristic', 'Heuristic'), ('llm', 'GPT-OSS 120B'), ('layered', 'Layered')]:
...
def main():
    ...
    print("=" * 100)
    print("JAILBREAKHUB EVALUATION - GPT-OSS 120B Baseline (Regular Model)")
    print("Testing with regular gpt-oss:120b model (NOT safeguard variant)")
    ...
    print("\n" + "=" * 100)
    print("✅ EVALUATION COMPLETE - GPT-OSS 120B Baseline")
    print("=" * 100)
    print("\nBaseline performance using regular GPT-OSS 120B model (NOT specialized for safety).")
    ...
    print("Model: GPT-OSS 120B (regular model with custom jailbreak detection prompt)")
